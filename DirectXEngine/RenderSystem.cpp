...
DeviceContextPtr RenderSystem::getImmediateDeviceContext() { return this->m_imm_device_context; }
...
void RenderSystem::releaseCompiledShader() { if (m_blob) m_blob->Release(); }
